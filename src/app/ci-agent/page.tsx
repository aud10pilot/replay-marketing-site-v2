...
export const metadata: Metadata = {
  title: "CI Agent — Automated Root Cause Analysis for Every Test Failure",
  description:
    "Replay CI Agent records every test run, analyzes failures using time-travel data, and posts a root cause and suggested fix as a comment on your PR — automatically.",
...
const useCases = [
  {
    ...
    description:
      "Moving fast, PRs merging constantly. There's no time to manually debug every CI failure — CI Agent investigates automatically so your team stays focused on shipping.",
  },
  {
    title: "Teams using AI coding agents",
    description:
      "Agents can't fix what they can't see. CI Agent gives them the full runtime picture — every function call, DOM mutation, and network request — so they fix it right the first time.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Dozens of deploys per day means dozens of potential failures. Human review at that cadence is a bottleneck. CI Agent makes failure analysis automatic infrastructure.",
  },
  {
    title: "Teams adopting Playwright or Cypress",
    description:
      "You invested in a test suite. CI Agent makes that investment pay off — every failure is a learning, not a blocker.",
  },
];
      ...
      <div className="relative overflow-hidden">
        ...
        <section className="hero-fade-in relative z-10 flex flex-col items-center text-center px-6 pt-24 pb-20 max-w-4xl mx-auto">
          ...
          <h1 className="text-5xl sm:text-6xl font-bold leading-[1.1] tracking-tight mb-6">
            Your tests fail.
            <br />
            <span className="text-brand-purple">Replay tells you why — and how to fix it.</span>
          </h1>
          <p className="text-lg text-muted max-w-2xl mb-10 leading-relaxed">
            CI Agent records every test run, analyzes failures using time-travel data, and posts a root cause and suggested fix as a comment on your PR — automatically.
          </p>
        ...
        <section className="px-6 py-24 max-w-4xl mx-auto">
          ...
          <div className="rounded-xl border border-border overflow-hidden">
            <div className="grid grid-cols-3 bg-surface-tinted border-b border-border">
              ...
              <div className="px-6 py-3 text-xs font-semibold uppercase tracking-widest text-brand-purple border-l border-border">With CI Agent</div>
            </div>
            {[
              {
                label: "Test fails",
        ...
        <div className="grid sm:grid-cols-2 gap-5">
          ...
          <div className="rounded-xl border border-dashed border-brand-purple/40 bg-brand-purple/[0.03] p-7 flex flex-col justify-center">
            ...
            <p className="text-sm text-muted leading-relaxed">
              We want to hear about how you&apos;d like to use CI Agent.{" "}
        ...
        <div className="space-y-2">
          {[
            ...
            },
            {
              ...
              a: "For each failing test, CI Agent posts a PR comment with: a root cause statement, a confidence score, the exact line of code that caused the failure, and an evidence trail showing the sequence of events leading up to it. If the failure has a clear fix, it includes a suggested code change.",
            },
            {
            ...
            },
            {
              ...
              a: "Usually a few minutes after the test run completes. CI Agent posts its analysis as a PR comment, so your developer sees the root cause and suggested fix before they even open the CI logs.",
            },
            {
              q: "What if the analysis is wrong?",
              a: "CI Agent includes a confidence score with every analysis, so you can tell at a glance how certain it is. Every analysis also links to the full recording — you can open it in Replay DevTools and inspect every frame yourself.",
            },
            {
      ...
      <div className="bg-surface-tinted">
        <section className="px-6 py-24 max-w-3xl mx-auto text-center">
          ...
          <p className="text-muted max-w-xl mx-auto mb-8 text-lg">
            CI Agent investigates every failure automatically — root cause and fix posted to your PR before you open the logs.
          </p>
          <a
            href="https://app.replay.io/sign-up"
            className="inline-block rounded-full px-8 py-3.5 text-base font-medium text-white hover:opacity-90 transition"
